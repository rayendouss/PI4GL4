...
import Interf.TimesheetServiceRemote;
...
public class TimesheetService implements TimesheetServiceRemote {
	...
	public int updateTimeSheet(int i ,Timesheet e) {
		...
		return em.createQuery("update Timesheet u set u.EtatTache='"+e.getEtatTache()+"' , u.NbreConge='"+e.getNbreConge()+"', u.etat='"+e.getEtat()+"', u.NbreHeureTRavJour='"+e.getNbreHeureTRavJour()+"' , u.NbreHeureTRavS='"+e.getNbreHeureTRavS()+"' where u.idT="+i).executeUpdate();
